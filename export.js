...
admin.initializeApp({
  ...
  databaseURL: 'https://weekend-coding.firebaseio.com'
});
...
let results = db
  ...
  .then(snapshot => {
    snapshot.forEach(doc => {
      ...
      data[collectionName][doc.id] = currentData;
      if (currentData.checkIn) {
        delete currentData.teachersWhoGavePoints;
        assistants.push(currentData);
      }
    });
    return assistants;
  })
